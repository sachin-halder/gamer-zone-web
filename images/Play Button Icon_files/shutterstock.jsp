			...
			try {
				...
				if (!usi_app.suppress_page) {
					...
					if (usi_app.is_image_page || usi_app.is_image_in_cart) {
						...
						} else if (usi_app.is_enabled && usi_app.is_checkout_page && checkout != null && (checkout.textContent.trim().indexOf("FLEX 10") != -1 || checkout.textContent.trim().indexOf("5 Credit Pack") != -1 || checkout.textContent.trim().indexOf("2 Credit Pack") != -1)) {
						...
						var checkout = document.querySelector('[data-automation="CheckoutOrderSummary_orderSummaryContainer_div"]');
						if (usi_app.is_enabled) threshold = 0;
						if (usi_app.is_enabled && usi_app.is_checkout_page && checkout != null && (checkout.textContent.trim().indexOf("FLEX 10") != -1 || checkout.textContent.trim().indexOf("5 Credit Pack") != -1 || checkout.textContent.trim().indexOf("2 Credit Pack") != -1)) {
